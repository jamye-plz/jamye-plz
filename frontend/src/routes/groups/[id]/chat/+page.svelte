<script lang="ts">
	...
	// chatroomId comes from group data
	...
	$effect(() => {
		...
		// TODO(oma-deferred): derive WS host from env for production
...
<div class="flex flex-col h-screen bg-background">
	<header class="shrink-0 sticky top-0 z-10 bg-background/80 backdrop-blur border-b border-border px-4 py-3 flex items-center gap-3">
		<button
