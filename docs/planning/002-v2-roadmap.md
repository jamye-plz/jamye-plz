...
> 잔여 기술부채는 [tech-debt-tracker.md](./tech-debt-tracker.md) #9 한 건뿐이다
> (#5 SW 푸시 구독 자동 복구는 2026-08-21 해결).
>
...
> ✅ **완료 — PR #22 머지** (2026-08-05). PR 리뷰 5라운드에서 6건 대응(수정 5 — 마이크 수명주기 3,
> transcript 프레임 경합+버퍼, 오디오 길이 캡 demux 프로브 — · 근거 있는 거절 1). 아래 "현재 상태"는 착수 전
